...
# ---- config ----
CKPT_PATH = "saved/model_-9148176231305158413_epoch_36.pt"  # replace XX with the epoch you want
...
test_ds = MyDataset('lists/coldstart/test.csv', cfg.DATA.PROTEIN_DIR, cfg.DATA.DRUG_DIR)
