...
# ---- config ----
CKPT_PATH = "saved/model_4257565100199224673_epoch_81.pt"  # replace XX with the epoch you want
...
test_ds = KIBADataset('lists/KIBA/test.csv', cfg.DATA.PROTEIN_DIR, cfg.DATA.DRUG_DIR)
