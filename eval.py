...
# ---- config ----
CKPT_PATH = "best_models/model_-3459988036641379738_epoch_39.pt"  # replace XX with the epoch you want
...
test_ds = KIBADataset(cfg.DATA.TEST_CSV_PATH, cfg.DATA.PROTEIN_DIR, cfg.DATA.DRUG_DIR)
